@echo off
rem ---------------------------------------------------------------------------
rem  ZEROING, FINE: nudge the picture DOWN by 0.4 degrees.
rem
rem  A FIFTH of the step the plain ZERO-DOWN.bat uses. Asked for on 2026-09-20,
...
> "%~dp0reframework\data\re_scope_cmd.txt" echo dzeroup -0.4

echo.
echo   Fine nudge DOWN 0.4 degrees.
echo.
