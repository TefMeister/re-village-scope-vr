@echo off
rem ---------------------------------------------------------------------------
rem  WHICH POINT OF THE LEFT HAND STEERS THE RIFLE: CONTROLLER
...
> "%~dp0reframework\data\re_scope_cmd.txt" echo fn grip_by_controller
echo.
echo   Rifle is steered by: CONTROLLER.
echo.
