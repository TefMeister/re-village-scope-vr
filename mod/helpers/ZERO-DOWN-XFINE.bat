@echo off
rem ---------------------------------------------------------------------------
rem  ZEROING, EXTRA FINE: nudge the picture DOWN by 0.2 degrees.
rem
...
> "%~dp0reframework\data\re_scope_cmd.txt" echo dzeroup -0.2

echo.
echo   Extra-fine nudge DOWN 0.2 degrees.
echo.
