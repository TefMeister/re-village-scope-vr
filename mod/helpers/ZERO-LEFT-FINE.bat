@echo off
rem ---------------------------------------------------------------------------
rem  ZEROING, FINE: nudge the picture LEFT by 0.4 degrees.
rem
rem  A FIFTH of the step the plain ZERO-LEFT.bat uses. Asked for on 2026-09-20,
...
echo.
echo   Fine nudge LEFT 0.4 degrees.
echo.
