@echo off
rem ---------------------------------------------------------------------------
rem  ZEROING: nudge the picture DOWN by 2 degrees.
rem
...
> "%~dp0reframework\data\re_scope_cmd.txt" echo dzeroup -2

echo.
echo   Nudged DOWN 2 degrees. Run it again for another 2.
echo.
